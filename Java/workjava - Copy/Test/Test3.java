...
/**************************************************
 * The test class MyDate.
 *
 * To include:
 * 1. Constructor MyDate (String date) testing 
...
public class Test3{
    ...
    /*********************************************************
     *  Test Date Constructor3 MyDate (String date)
     ********************************************************/
    @Test
    public void testConstructor3(){
        d = new MyDate("4/2/1963");
    ...
    public void testEquals(){
        MyDate d1 = new MyDate(4,20,1963);
        MyDate d2 = new MyDate(4,20,1963);
    ...
    private void testInvalidDayUpperBound(String method){
        ...
        for (int i = 0 ; i <= 11 ; i++) {
            ...
            if (i == 1) {
                ...
                switch (method){
                    case "constructor2":
                        d = new MyDate (i + 1, monthDays [i] + 1, 2020);
                        Assert.assertEquals(" invalid day for month - " +
                                "constructor should create the default date","10/12/2020", d.toString());
                        break;

                    case "constructor3":
                        d = new MyDate ((i + 1) + "/" + (monthDays [i] + 1) +
                                "/" + "2020");
                        Assert.assertEquals(" invalid day for month - " +
                                "constructor should create the default date","10/12/2020", d.toString());
                        break;
